class ProdutoService {
    constructor() {
        this.produtos = [
            { id: 1, nome: "Café", preco: 15.50, estoque: 10 },
            { id: 2, nome: "Arroz 1kg", preco: 10.50, estoque: 50 },
            { id: 3, nome: "Feijão 1kg", preco: 8.50, estoque: 20 },
            { id: 4, nome: "Leite 2L", preco: 8.50, estoque: 30 }
        ];
    }
    ...
    listarPorPreco(preco) {
        return this.produtos.filter(item => item.preco.toFixed(2) == preco.toFixed(2));
    }
